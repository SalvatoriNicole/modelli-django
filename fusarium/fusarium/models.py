...
class Daily(models.Model):
    ...
    humidity = models.FloatField(default=0)#,blank=False, null=False) 
...
class State(models.Model):
    ...
    RintMax_P_t0=models.FloatField(default=0) #models.IntegerField()
    RH80_t0=models.FloatField(default=0) #models.IntegerField()
    Rtot_P_t0=models.FloatField(default=0) #models.IntegerField()
    rain_streak=models.FloatField(default=0) #models.IntegerField()

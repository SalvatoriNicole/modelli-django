...
class State(models.Model):
    ...
    hours_of_wetness_t0 = models.FloatField(default=0) #models.IntegerField()
    hours_of_dry_t0 = models.FloatField(default=0) #models.IntegerField()
    T_min=models.FloatField(default=5)
    T_max=models.FloatField(default=30)
    T_opt=models.FloatField(default=25) 
    W_min=models.FloatField(default=4) 
    W_max=models.FloatField(default=24)    
...
class Phytophtora(models.Model):
